const
  ...
  clientConfig = {
    connector: require('./certs/client.js'),
    tlsServer: require('./certs/server.js')
  },
  clientParam = {
    ...
    dapsVcPath: '/vc',
    // dapsAboutPath: '/.well-known/oauth-authorization-server',
    dapsAboutPath: '/about',
...
describe.skip('ids.client.nrd-daps', function () {
  ...
  describe('manual setup', function () {
    ...
    test('get oauth metadata', async function () {
      const response = await fetch(
        clientParam.dapsUrl + clientParam.dapsAboutPath,
